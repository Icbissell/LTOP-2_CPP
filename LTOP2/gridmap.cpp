...
void GridMap::get_input(){
    ...
    std::string topoPath = "path-to-topography"; // link topography csv array here
...
void GridMap::calc_fc(){
    ...
    /* This function is optional, and if not invoked, the remainder of LTOP2 does not require latitude and longitude arrays */
    ...
    std::string latPath = "path-to-latitude-file"; // link topography DEM here
    std::ifstream inLat(latPath); //link to latitude file here
    ...
    std::string lonPath = "path-to-longitude-file"; // link topography DEM here
    std::ifstream inLon(lonPath); //link to longitude file here
